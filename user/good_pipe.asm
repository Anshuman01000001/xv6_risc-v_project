...
main(void)
{
  ...
  40:	300000ef          	jal	340 <close>
    ...
    exit(0);
  44:	4501                	li	a0,0
  46:	2d2000ef          	jal	318 <exit>
        close(fd[0]);   // close the reader
  4a:	fd842503          	lw	a0,-40(s0)
  4e:	2f2000ef          	jal	340 <close>
        write(fd[1], msg, strlen(msg));  // write to the pipe
  52:	fdc42483          	lw	s1,-36(s0)
  56:	00001517          	auipc	a0,0x1
  5a:	8aa50513          	addi	a0,a0,-1878 # 900 <malloc+0x104>
  5e:	07e000ef          	jal	dc <strlen>
  62:	0005061b          	sext.w	a2,a0
  66:	00001597          	auipc	a1,0x1
  6a:	89a58593          	addi	a1,a1,-1894 # 900 <malloc+0x104>
  6e:	8526                	mv	a0,s1
  70:	2c8000ef          	jal	338 <write>
        close(fd[1]);   // close the writer
  74:	fdc42503          	lw	a0,-36(s0)
  78:	2c8000ef          	jal	340 <close>
        wait(0);    
  7c:	4501                	li	a0,0
  7e:	2a2000ef          	jal	320 <wait>
  82:	b7c9                	j	44 <main+0x44>
...
printint(int fd, long long xx, int base, int sgn)
{
 ...
 3fc:	55050513          	addi	a0,a0,1360 # 948 <digits>
 400:	883e                	mv	a6,a5
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 692:	2bab8b93          	addi	s7,s7,698 # 948 <digits>
 ...
 6f4:	25090913          	addi	s2,s2,592 # 940 <malloc+0x144>
        for(; *s; s++)
